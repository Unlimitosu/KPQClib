...
// (3) Send c1h_a and c1h_b from mod q to mod k1(64) and mod k2(64).
	for (i=0; i< LWE_N; ++i) {
		c[i] = ((c1[i] + 0x02) & 0xfc);
		c[LWE_N + i] = ((c2[i] + 0x02) & 0xfc);    // 8=0x10/0xe0, 16=0x08/0xf0, 32=0x04/0xf8 64=0x02/0xfc, 128= 0x01 0xfe
	}
}
