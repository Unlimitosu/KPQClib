...
int _hash( unsigned char * digest , const unsigned char * m , unsigned long long mlen )
{
	...
	sha256ctx sha256;
	sha256_inc_init(&sha256);
	sha256_inc_blocks(&sha256, m, mlen);
	sha256_inc_finalize(digest, &sha256, m, mlen);
#endif
#elif 48 == _HASH_LEN
#if defined(_SUPERCOP_)
	...
	sha512ctx sha384;
	sha384_inc_init(&sha384);
	sha384_inc_blocks(&sha384, m, mlen);
	sha384_inc_finalize(digest, &sha384, m, mlen);
#endif
#elif 64 == _HASH_LEN
#if defined(_SUPERCOP_)
	...
	sha512_inc_blocks(&sha512, m, mlen);
	sha512_inc_finalize(digest, &sha512, m, mlen);
#endif
#else
