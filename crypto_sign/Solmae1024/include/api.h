...
#define CRYPTO_SECRETKEYBYTES 32769 // 32768 bytes + header 1 byte
#define CRYPTO_PUBLICKEYBYTES 8193  // 8192 bytes + header 1 byte
#define CRYPTO_BYTES 16425          // nonce 40 bytes + header 1 bytes + signature 8192 * 2 bytes
#define CRYPTO_ALGNAME "Solmae-1024"
